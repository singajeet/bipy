...
class ConnectionManager:
    """ A SQLite connection manager class which is a
    ...
    def __new__(cls, val):
        """ The singleton constructor for this class
            ...
            Return:
                ConnectionManager: An singleton instance of this class
        """
    ...
    def get_connection_string(self):
        """Returns the connection string used in this class for mmaking
